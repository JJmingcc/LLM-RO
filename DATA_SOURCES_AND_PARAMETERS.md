...
graph TD
    ...
    C --> C1[λ: Arrival Rates<br/>Uniform Distribution]
    C --> C2[p_c: GPU Costs<br/>±20% Market Variation]
    C --> C3[α: Compute Rates<br/>Task-Dependent Ranges]
    C --> C4[ρ, φ: Penalties<br/>Business-Driven Ranges]

    D --> D1[d = base × model × GPU<br/>3D Tensor]
    D --> D2[e = base/capacity × precision<br/>3D Tensor]

    E --> E1[d_hat = 10-25% of d_bar]
    E --> E2[e_hat = 10-25% of e_bar]
    E --> E3[Γ_d, Γ_e = 10<br/>Budgeted Uncertainty]
